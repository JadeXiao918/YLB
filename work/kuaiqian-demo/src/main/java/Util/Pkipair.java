    ...
    public class Pkipair {
        ...
        public String signMsg( String signMsg) {
            ...
            try {
                ...
                //生成私钥
                System.out.println(Pkipair.class.getClassLoader().getResource("Util/10012140356.pfx").getPath());
                String file = Pkipair.class.getClassLoader().getResource("Util/10012140356.pfx").getPath().replaceAll("%20", " ");
