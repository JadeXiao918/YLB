...
import com.ylb.util.HttpUtil;
import com.ylb.util.Pkipair;
...
public class KuaiQianService {
    ...
    public Map<String,String> generateFormData(Integer uid,String phone ,BigDecimal rechargeMoney) {
        ...
        String bgUrl = "https://769z4319s5.goho.co/pay/kq/rece/notify";
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
    ...
    public void kqNotify(HttpServletRequest request) {
        ...
        if (flag){
            ...
            System.out.println("订单"+orderId+"验证失败，不能处理");
        }
        //删除redis中的订单记录
    ...
    public void handlequeryOrder() {
        //从redis获取订单号
        Set<String> orders = stringRedisTemplate.boundZSetOps(RedisKey.KEY_ORDERID_SET)
                .range(0, -1);
        //循环订单号
